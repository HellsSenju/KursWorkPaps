...
void DeleteRuleController::service(HttpRequest &request, HttpResponse &response)
{
    ...
    if(!checkRequest(req)){
        ...
        QThread* thread = network->post("/delete", ip, port, body);
...
bool DeleteRuleController::checkRequest(QJsonObject request)
{
